...
public class AdminStationAdapter extends RecyclerView.Adapter<StationViewHolder>  {
    ...
    public void onBindViewHolder(StationViewHolder holder, int position) {
        if(summaryMode){
            ...
            holder.station.setText( ((Context) activity).getString(R.string.station_admin_list_item_summary, item.station.id, item.evaluated, item.done, item.sum) );
            ...
            holder.station.setText(((Context) activity).getString(R.string.station_admin_list_item, item.station.id));
            int color;
            switch (item.status) {
                case Evaluated:
                    color = colorDone;
